...
const NftCard = ({
    ...
    return (
        <div className="relative block rounded-2.5xl border border-[#189C87] bg-transparent p-[1.1875rem] transition-shadow hover:shadow-lg" style={{ maxWidth: "300px" }}>
            ...
            >
                <span className="mr-1 text-[#f9f9f9]">
                    {Description}
                </span>
            </div>
        </div>
