...
const apply = ({ signer_address, create_new_collection }) => {
                    ...
                    <div className="container">
                        ...
                        <div className="mx-auto max-w-[48.125rem]">
                            ...
                            <div className="mb-6">
                                ...
                                <p className="mb-3 text-2xs dark:text-jacarta-300">
                                    Once you apply for the launchpad your details will be reviewed and you will get contacted <br />  by our team on your submitted email.
                                </p>
                            </div>
