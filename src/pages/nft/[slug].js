                ...
                <section className="relative pt-12 pb-24 lg:py-24 mt-10" id="heroBack">
                    <div className="container">
                        <div className="md:flex md:flex-wrap">
                            <div className="relative mb-8 md:w-2/5 md:flex-shrink-0 md:flex-grow-0 md:basis-auto lg:w-1/2" style={{ display: "flex", justifyContent: 'center', alignItems: "center" }}>
                                <Image
                                    src={"https://gateway.ipfscdn.io/ipfs/QmeZG7hon5Zj4E9nbYTBKRqYNV2FBxgdscqinLioabWJp4/details%20(1).png"}
                                    width={80}
                                    height={80}
                                    alt="item"
                        ...
                        <div className="scrollbar-custom mt-14 overflow-x-auto rounded-lg">
                            <div className="min-w-fit">
                                <ul className="nav nav-tabs flex items-center" role="tablist">
                                    ...
                                    >
                                        <button
                                            className={` ${propShow && "text-[#189C87] active relative border-b-2 border-b-[#189C87]"} flex items-center whitespace-nowrap py-3 px-6  hover:text-jacarta-200`}
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24"
                                    ...
                                    >
                                        <button
                                            className={`${!propShow && "text-[#189C87] active relative border-b-2 border-b-[#189C87]"} flex items-center whitespace-nowrap py-3 px-6 text-jacarta-200`}
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24"
